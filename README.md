...
| **Private preview** for the person (`interview-preview.html?t=` → `GET /api/interview?preview=1`): the article exactly as published, visible only to the signed-in owner (their LinkedIn email is linked to the interview) and to admins | Preview / *I'm happy with this version* buttons sit at the top and bottom of the questions |
